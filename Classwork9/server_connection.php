...
function insertEmployeeRecord($connection) {
...
insertEmployeeRecord($connection);

function displayEmployeeRecords($connection) {
...
// Display the records from the Employees table
